...
REM
REM Generated by Vivado on Sun Jul 10 17:35:38 +0200 2022
...
echo "xvlog --incr --relax -L uvm -prj ReadTachTB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ReadTachTB_vlog.prj -log xvlog.log
